...
const css$2 = {
  code: ".text.svelte-1e8wuax{font-weight:600}form.svelte-1e8wuax{display:flex;flex-direction:column}label.svelte-1e8wuax{font-weight:600;font-size:20px;color:var(--red);text-transform:uppercase;margin-bottom:10px}input.svelte-1e8wuax{margin-bottom:10px;height:25px;padding-left:5px;border:1px solid black}textarea.svelte-1e8wuax{padding:5px;min-height:140px;border:1px solid black}button.svelte-1e8wuax{text-align:left;color:var(--red);font-size:25px;background-color:unset;width:min-content;margin-top:20px;font-weight:600;border:unset;cursor:pointer}small.svelte-1e8wuax{color:red;font-size:12px;font-weight:600}",
  map: null
};
const ContactFrom = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $form, $$unsubscribe_form;
  let $errors, $$unsubscribe_errors;
  const { form, errors, constraints, enhance: enhance2 } = superForm($form, { validators: emailSchema });
  $$unsubscribe_form = subscribe(form, (value) => $form = value);
  $$unsubscribe_errors = subscribe(errors, (value) => $errors = value);
  $$result.css.add(css$2);
  $$unsubscribe_form();
  $$unsubscribe_errors();
  return `<div><div class="text svelte-1e8wuax" data-svelte-h="svelte-61dtts">You can email me using this form!</div> <form id="myForm" method="post" class="svelte-1e8wuax"><label for="name" class="svelte-1e8wuax" data-svelte-h="svelte-bs9sy6">Name</label> <input type="text" name="name" id="name" class="svelte-1e8wuax"${add_attribute("value", $form.name, 0)}> ${$errors.name ? `<small class="svelte-1e8wuax" data-svelte-h="svelte-olwwqw">Field is required!</small>` : ``} <label type="text" for="email" class="svelte-1e8wuax" data-svelte-h="svelte-19jp8yc">Email</label> <input type="text" name="email" id="email" class="svelte-1e8wuax"${add_attribute("value", $form.email, 0)}> ${$errors.email ? `<small class="svelte-1e8wuax" data-svelte-h="svelte-1rrvgs1">Incorrect email</small>` : ``} <label type="text" for="subject" class="svelte-1e8wuax" data-svelte-h="svelte-dk9k1g">Subject</label> <input type="text" name="subject" id="subject" class="svelte-1e8wuax"${add_attribute("value", $form.subject, 0)}>  ${$errors.subject ? `<small class="svelte-1e8wuax" data-svelte-h="svelte-olwwqw">Field is required!</small>` : ``} <label for="message" class="svelte-1e8wuax" data-svelte-h="svelte-4uee20">Message</label> <textarea id="message" cols="10" name="message" class="svelte-1e8wuax">${escape($form.message || "")}</textarea>  ${$errors.message ? `<small class="svelte-1e8wuax" data-svelte-h="svelte-mxn2z9">Field is required!!</small>` : ``} <button class="svelte-1e8wuax" data-svelte-h="svelte-1dvi08a">Send</button></form> </div>`;
});
const Experience_svelte_svelte_type_style_lang = "";
const css$1 = {
  code: ".container.svelte-mgoodx{display:flex;flex-direction:column;text-transform:uppercase;font-weight:600;row-gap:30px;padding-top:20px}.workplace.svelte-mgoodx{color:var(--red);font-size:20px;margin-bottom:5px}.date.svelte-mgoodx{color:var(--blue);font-size:16px;margin-bottom:10px}.text.svelte-mgoodx{font-size:12px}a.svelte-mgoodx{font-size:12px}",
  map: null
};
const Experience = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="container svelte-mgoodx">${each(workplaces, (w) => {
    return `<div><div class="workplace svelte-mgoodx">${escape(w.title)}</div> ${w?.link ? `<a${add_attribute("href", w.link, 0)} target="_blank" class="svelte-mgoodx">${escape(w.link)} </a>` : ``} ${w?.date ? `<div class="date svelte-mgoodx">${escape(w.date)} </div>` : ``} ${w?.description ? `<div class="text svelte-mgoodx">${escape(w.description)} </div>` : ``} </div>`;
  })} </div>`;
});
